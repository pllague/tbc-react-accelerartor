      ...
      <div className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center bg-secondary/80 z-[999]">
        ...
        >
          ...
          <div className="w-full flex gap-3">
            ...
            <button
              className="w-full h-full border-0 bg-blue-500 hover:bg-orange rounded-[5px] py-3 lg:py-auto px-7 font-small lg:text-[20px] lg:font-medium cursor-pointer transition-all transform duration-300 ease-linear text-white"
              type="submit"
            >
              Save
            </button>
