                ...
                <div className="flex flex-col gap-3 h-full px-[18px] lg:px-[22px]">
                    ...
                    <div className="flex flex-col gap-3 justify-between items-center">
                        ...
                        <div className="w-full">
                            <button className="group w-full flex justify-center gap-3 items-center lg:py-2 border border-yellow-600 dark:border-light_blue rounded-[10px] lg:rounded-[12px] hover:border-orange hover:text-orange transition-all duration-300 ease-in-out">
