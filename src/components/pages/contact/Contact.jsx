                ...
                <div className="w-1/3 flex flex-col gap-5 justify-between items-start mx-auto border-b-2 border-light_blue pb-2">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex  gap-5 group">
                            ...
                            <a href="mailto:react@example.com" className="text-[30px] group-hover:text-orange transition-all transform duration-300 ease-linear">react@example.com</a>
                        </div>
                        <div className="flex  gap-5 items-center group">

                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 group-hover:stroke-orange transition-all transform duration-300 ease-linear">
                        ...
                        <div className="flex  gap-5 items-center group">
                            ...
                            <a href="tel:+77777777777" className="text-[30px] group-hover:text-orange transition-all transform duration-300 ease-linear">0777 777 777 77</a>
