...
const Profile = () => {
    ...
    return (
        <>
            <h2 className="text-[40px] leading-[25px] text-center my-[20px]">Edit Your Profile Data</h2>
            <form className="w-1/5 border-2 border-light_blue shadow-xl shadow-light_blue p-8 rounded-xl flex flex-col gap-3 justify-between items-start mx-auto">
